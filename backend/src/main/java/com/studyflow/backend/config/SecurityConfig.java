...
import com.studyflow.backend.security.AuthSecurityFilter;
import com.studyflow.backend.security.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(
                "http://localhost:5173",
                "https://study-flow-eta-eight.vercel.app/"
        ));
